        ...
        <div className="flex-1 space-y-5 overflow-y-auto px-6 py-6">
          <div>
            ...
            <input
              ...
              className="mt-1.5 w-full rounded-md border border-ink/15 bg-paper px-3 py-2 text-lg font-medium text-ink outline-none focus:border-brand"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={8}
              className="mt-1.5 w-full resize-none rounded-md border border-ink/15 bg-paper px-3 py-2 text-sm text-ink outline-none focus:border-brand"
            />
          </div>
  ...
  return (
    <div>
      ...
      <select
        ...
        className="mt-1.5 w-full rounded-md border border-ink/15 bg-paper px-2 py-1.5 text-sm capitalize"
      >
        {options.map((o) => (
